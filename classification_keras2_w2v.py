...
w2v = Word2Vec(X_train,vector_size=vec_length,min_count=1)
# get generated space
...
embedding_layer = Embedding(max_length, embedding_dim, input_length=max_length)
